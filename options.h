...
#define DEFAULT_PRAGMAS PRAGMA_WARNINGS + PRAGMA_ERROR_CONTEXT + PRAGMA_SAVE_BINARY + PRAGMA_STRICT_TYPES
 ...
 */
// last modified by soso on 2010-10-29 for debug binaries support
